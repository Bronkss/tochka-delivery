...
function resolveHandler(moduleName, module) {
...
function setQuery(req, extraQuery) {
...
const categoryProductsHandler = resolveHandler('api/categories/[category]/products', categoryProductsModule);
...
const telegramWebhookHandler = resolveHandler('api/telegram-webhook', telegramWebhookModule);
const setTelegramWebhookHandler = resolveHandler('api/set-telegram-webhook', setTelegramWebhookModule);
...
app.all('/api/categories/:category/products', wrapHandler(categoryProductsHandler, (req) => ({
